...
export function CognitiveProfile() {
  ...
  const categories = [
    ...
    { key: 'resilience', title: 'Стрессоустойчивость', descStrong: 'Вы сохраняете продуктивность в условиях высокой когнитивной нагрузки и асинхронности.', descWeak: 'Уровень стресса высок. Рекомендуем Редукцию шума и дыхательную технику ЦРУ «Тишина».' },
  ];
