      ...
      {isOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-[110] p-4">
          ...
          >
            ...
            <button onClick={onClose} aria-label="Закрыть" className="absolute top-4 right-4 min-h-11 min-w-11 hover:bg-secondary rounded-full transition-colors flex items-center justify-center">
              <X className="w-5 h-5" />
            </button>
            ...
            <div className="space-y-3">
              <div className="p-4 bg-secondary/30 rounded-2xl border border-border">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button onClick={() => copyToClipboard(getWallet(), 'wallet')} aria-label="Копировать кошелёк" className="min-h-11 min-w-11 hover:bg-background rounded-lg transition-colors flex items-center justify-center">
