  ...
  return (
    <div className="site-shell" id="top">
      ...
      <header className="nav-wrap"><nav className="nav container" aria-label="Основная навигация">
        <Logo />
        <div className="nav-links"><a href="#product">Продукт</a><a href="#market">Рынок</a><a href="#capital">Инвестиции</a><a href="#glossary">Термины</a></div>
