    ...
    <div className="site-shell" id="top">
      ...
      <main id="main">
        <section className="hero container" aria-labelledby="hero-title"><div className="hero-copy">
          ...
          <p className="hero-context">Когда AI берёт на себя рутину, ценность самостоятельного внимания, памяти и решений становится заметнее.</p>
        ...
        <section className="section container team-section" id="team"><SectionIntro eyebrow="Команда" title="Основатель отвечает за продукт и инженерную реализацию." /><div className="market-position"><p>Сергей Богорад — основатель и product/engineering owner с 15-летним инженерным опытом в крупной компании. AI-инструменты ускоряют прототипирование и технические проверки, но ответственность за продукт, архитектуру и решения остаётся у основателя.</p><p>Такой подход помогает проверить продуктовую гипотезу с минимальным бюджетом до найма. Технический сооснователь — следующий плановый найм после подтверждения спроса.</p></div></section>
