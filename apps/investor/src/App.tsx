    ...
    <div className="site-shell" id="top">
      ...
      <main id="main">
        <section className="hero container" aria-labelledby="hero-title"><div className="hero-copy">
          ...
          <p className="hero-lead">Kognitika — тренажёры и история прогресса, собранные в понятный цикл: короткое занятие, измеримый результат, следующий шаг, возвращение к практике.</p>
          <p className="hero-context">AI берёт на себя всё больше интеллектуальной рутины. Поэтому особенно важны навыки, которые остаются за человеком: удерживать внимание, учиться, проверять вывод, принимать решение. Мы помогаем их регулярно практиковать — а не обещаем заменить мышление AI.</p>
