...
export default function InvestorSummaryPage() {
  ...
  return <div className="investor-summary-page" id="top">
    ...
    <main id="summary-main">
      ...
      <section className="summary-contact" id="contact"><div className="summary-container"><p className="summary-kicker">Следующий шаг</p><h2>Материалы и разговор, по запросу</h2><p>Отвечаем в течение одного рабочего дня. Закрытая папка с материалами открывается вручную после короткого знакомства, без публичных ссылок.</p><a href="/#contact">Запросить материалы <ArrowRight size={17} aria-hidden="true" /></a></div></section>
    </main>
  </div>;
}
