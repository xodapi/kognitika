...
- [~] Add module metadata, lifecycle ownership, and collector integration to each supported cognitive engine. Schulte, N-Back, Stroop, Numerical, and Logical are adopters; remaining engines are pending.
...
- [~] Add deterministic synthetic fixtures for each module family. Schulte, N-Back, Stroop, Numerical, and Logical coverage is added; remaining module families are pending.
