...
- [~] Add module metadata, lifecycle ownership, and collector integration to each supported cognitive engine. Schulte, N-Back, Stroop, Numerical, Logical, Typing, and Spatial are adopters; remaining engines are pending.
...
- [~] Add deterministic synthetic fixtures for each module family. Schulte, N-Back, Stroop, Numerical, Logical, Typing, and Spatial coverage is added; remaining module families are pending.
