...
- [~] Add module metadata, lifecycle ownership, and collector integration to each supported cognitive engine. Schulte, N-Back, Stroop, Numerical, Logical, Typing, Spatial, Mental Math, Dispatcher, and Collision are adopters; remaining engines are pending.
...
- [~] Add deterministic synthetic fixtures for each module family. Schulte, N-Back, Stroop, Numerical, Logical, Typing, Spatial, Mental Math, Dispatcher, and Collision coverage is added; remaining module families are pending.
